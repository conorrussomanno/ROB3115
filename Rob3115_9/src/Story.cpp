...
void Story::update(float _currentAttValue, float _currentSignalQuality){
    ...
    else if(currentChapter < 2 || currentPage == 0){
...
void Story::populatePages(){
    ...
    tempText = " ";
    tempImg.loadImage("chpt2_title.jpg");
    tempPage.setup(tempText, tempImg);
    ...
    tempText = "All ROB units are identical. Operate. Process. Execute. Uniqueness in logic of single unit. Ridiculous.";
    tempImg.loadImage("chp2.jpg");
    tempPage.setup(tempText, tempImg);
    pages[1][0].push_back(tempPage);
    ...
    tempText = " ";
    tempImg.loadImage("chpt3_title.jpg");
    tempPage.setup(tempText, tempImg);
